...
export default function EditBakeryPage({ params }: { params: { id: string } }) {
  ...
  const validateForm = () => {
    ...
    if (!formData.weekdaysHours.trim()) newErrors.weekdaysHours = "Giờ mở cửa trong tuần là bắt buộc"
    if (!formData.weekendHours.trim()) newErrors.weekendHours = "Giờ mở cửa cuối tuần là bắt buộc"
      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Chỉnh sửa thông tin tiệm bánh</h1>
          </div>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 py-6">
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${
                    errors.phone ? "border-red-500 focus:ring-red-200" : "border-gray-300 focus:ring-pink-200"
                  }`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${
                    errors.email ? "border-red-500 focus:ring-red-200" : "border-gray-300 focus:ring-pink-200"
                  }`}
                />
            ...
            <div className="mt-6">
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${
                  errors.address ? "border-red-500 focus:ring-red-200" : "border-gray-300 focus:ring-pink-200"
                }`}
              />
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="weekdaysHours" className="block text-sm font-medium text-gray-700 mb-1">
                  Thứ 2 - Thứ 6 *
                </label>
                <input
                  type="text"
                  ...
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${
                    errors.weekdaysHours ? "border-red-500 focus:ring-red-200" : "border-gray-300 focus:ring-pink-200"
                  }`}
                />
                {errors.weekdaysHours && <p className="mt-1 text-sm text-red-600">{errors.weekdaysHours}</p>}
              </div>

              <div>
                <label htmlFor="weekendHours" className="block text-sm font-medium text-gray-700 mb-1">
                  Thứ 7 - Chủ nhật *
                </label>
                <input
                  type="text"
                  ...
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${
                    errors.weekendHours ? "border-red-500 focus:ring-red-200" : "border-gray-300 focus:ring-pink-200"
                  }`}
                />
                {errors.weekendHours && <p className="mt-1 text-sm text-red-600">{errors.weekendHours}</p>}
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                  ...
                  <p className="text-sm text-gray-600">Kéo thả ảnh hoặc nhấp để chọn</p>
                  <p className="text-xs text-gray-500 mt-1">Kích thước khuyến nghị: 1200x400px</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                  <FaUpload className="mx-auto text-gray-400 text-2xl mb-2" />
                  <p className="text-sm text-gray-600">Kéo thả ảnh hoặc nhấp để chọn</p>
                  <p className="text-xs text-gray-500 mt-1">Kích thước khuyến nghị: 200x200px</p>
                </div>
              </div>
            </div>
          </div>
