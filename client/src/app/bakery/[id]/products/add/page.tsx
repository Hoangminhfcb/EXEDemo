...
import { FaArrowLeft, FaSave, FaImage, FaPlus, FaTrash, FaCheck } from "react-icons/fa"
...
export default function AddProductPage({ params }: { params: { id: string } }) {
  ...
  const validateForm = () => {
    ...
    if (formData.hasDiscount && formData.discountPrice.trim() === "")
      ...
      newErrors.discountPrice = "Giá khuyến mãi phải là số dương và nhỏ hơn giá gốc"

    if (productImages.length === 0) newErrors.images = "Cần ít nhất một hình ảnh sản phẩm"
    ...
    if (formData.stock === "limited" && !formData.stockQuantity.trim())
      ...
      (isNaN(Number(formData.stockQuantity)) || Number(formData.stockQuantity) < 0)
    )
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ ...errors, submit: "Có lỗi xảy ra khi thêm sản phẩm. Vui lòng thử lại." })
    } finally {
      setIsLoading(false)
    }
  }
      ...
      {showSuccess && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full">
            ...
            <h3 className="text-xl font-semibold text-center mb-2">Thêm sản phẩm thành công!</h3>
            <p className="text-gray-600 text-center">Sản phẩm của bạn đã được thêm vào danh sách.</p>
          </div>
        </div>
      )}
      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center">
            <Link href={`/bakery/${bakeryId}`} className="text-pink-600 hover:text-pink-700 mr-4">
              <FaArrowLeft />
            </Link>
        ...
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${
                    errors.name ? "border-red-500 focus:ring-red-200" : "border-gray-300 focus:ring-pink-200"
                  }`}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${
                    errors.category ? "border-red-500 focus:ring-red-200" : "border-gray-300 focus:ring-pink-200"
                  }`}
                >
            ...
            <div className="mt-6">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${
                  errors.description ? "border-red-500 focus:ring-red-200" : "border-gray-300 focus:ring-pink-200"
                }`}
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${
                    errors.price ? "border-red-500 focus:ring-red-200" : "border-gray-300 focus:ring-pink-200"
                  }`}
                  placeholder="VD: 350000"
                />
                {errors.price && <p className="mt-1 text-sm text-red-600">{errors.price}</p>}
                {formData.price && !errors.price && (
                  <p className="mt-1 text-sm text-gray-600">= {formatPrice(formData.price)}</p>
                )}
              </div>
              ...
              <div className="flex flex-col">
                <div className="flex items-center mb-2">
                  ...
                  />
                  <label htmlFor="hasDiscount" className="ml-2 block text-sm text-gray-700">
                    Có giảm giá
                  </label>
                </div>
                ...
                {formData.hasDiscount && (
                  <div>
                    ...
                    {formData.discountPrice && !errors.discountPrice && (
                      <p className="mt-1 text-sm text-gray-600">= {formatPrice(formData.discountPrice)}</p>
                    )}
                  </div>
                )}
              </div>
            ...
            <div className="mt-6">
              ...
              <p className="text-xs text-gray-500">
                Sản phẩm nổi bật sẽ được hiển thị ở vị trí đặc biệt trên trang của bạn
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            >
              ...
              <p className="text-sm text-gray-600">Nhấp để chọn hoặc kéo thả hình ảnh vào đây</p>
              <p className="text-xs text-gray-500 mt-1">Hỗ trợ: JPG, PNG, GIF (Tối đa 5MB/ảnh)</p>
            </div>
            ...
            <div className="mt-4 grid grid-cols-2 gap-4">
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-pink-600 focus:ring-pink-500 border-gray-300 rounded"
                />
                <label htmlFor="availableForDelivery" className="ml-2 block text-sm text-gray-700">
                  Có giao hàng
                </label>
              </div>
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-pink-600 focus:ring-pink-500 border-gray-300 rounded"
                />
                <label htmlFor="availableForPickup" className="ml-2 block text-sm text-gray-700">
                  Có lấy tại cửa hàng
                </label>
              </div>
            </div>
            ...
            <div className="mb-4">
              <div className="flex items-center space-x-4">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="stockUnlimited" className="ml-2 block text-sm text-gray-700">
                    Không giới hạn
                  </label>
                </div>
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-pink-600 focus:ring-pink-500 border-gray-300"
                  />
                  <label htmlFor="stockLimited" className="ml-2 block text-sm text-gray-700">
                    Có giới hạn
                  </label>
                </div>
              </div>
            ...
            {formData.stock === "limited" && (
              <div>
                ...
                <input
                  ...
                  min="0"
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${
                    errors.stockQuantity ? "border-red-500 focus:ring-red-200" : "border-gray-300 focus:ring-pink-200"
                  }`}
                />
