...
export default function BakeryPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-64 md:h-80">
        <Image src={bakery.coverImage || "/placeholder.svg"} alt={bakery.name} fill className="object-cover" priority />
              ...
              <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                <div>
                  <div className="flex items-center mb-2">
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mr-3">{bakery.name}</h1>
                    {bakery.premium && (
                  ...
                  <div className="flex items-center mb-3">
                    <div className="flex items-center">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <FaStar
                          key={star}
                          className={`w-5 h-5 ${star <= Math.floor(bakery.rating) ? "text-yellow-400" : "text-gray-300"}`}
                        />
                      ))}
                      <span className="ml-2 text-gray-600 font-medium">{bakery.rating}</span>
                    </div>
      ...
      <div className="container mx-auto px-4 mb-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white rounded-lg shadow-sm p-4 text-center">
            ...
            <div className="text-2xl font-bold text-gray-900">{bakery.stats.views.toLocaleString()}</div>
            <div className="text-sm text-gray-600">Lượt xem</div>
          </div>
          <div className="bg-white rounded-lg shadow-sm p-4 text-center">
            <FaHeart className="text-red-600 text-2xl mx-auto mb-2" />
            <div className="text-2xl font-bold text-gray-900">{bakery.stats.favorites.toLocaleString()}</div>
            <div className="text-sm text-gray-600">Yêu thích</div>
          </div>
          <div className="bg-white rounded-lg shadow-sm p-4 text-center">
            <FaShoppingCart className="text-green-600 text-2xl mx-auto mb-2" />
            <div className="text-2xl font-bold text-gray-900">{bakery.stats.orders.toLocaleString()}</div>
            <div className="text-sm text-gray-600">Đơn hàng</div>
          </div>
          <div className="bg-white rounded-lg shadow-sm p-4 text-center">
            <FaStar className="text-yellow-600 text-2xl mx-auto mb-2" />
            <div className="text-2xl font-bold text-gray-900">{bakery.stats.rating}</div>
      ...
      <div className="container mx-auto px-4 pb-12">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{bakery.owner.title}</p>
                    <p className="text-sm text-gray-600">{bakery.owner.experience}</p>
                  </div>
                </div>
                <p className="text-sm text-gray-600">Thành viên từ: {formatDate(bakery.memberSince)}</p>
              </div>
        ...
        {activeTab === "products" && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-semibold">Tất cả sản phẩm ({products.length})</h2>
              {isOwner && (
                <Link
                  href={`/bakery/${bakeryId}/products/add`}
        ...
        {activeTab === "reviews" && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h2 className="text-xl font-semibold mb-6">Đánh giá từ khách hàng ({reviews.length})</h2>
            <div className="space-y-6">
              {reviews.map((review) => (
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center mb-2">
                        ...
                        <span className="ml-2 text-sm text-gray-600">cho {review.productName}</span>
                      </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">T2-T6: {bakery.operatingHours.weekdays}</p>
                    <p className="text-gray-600">T7-CN: {bakery.operatingHours.weekend}</p>
                  </div>
                </div>
                <div>
