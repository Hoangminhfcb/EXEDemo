...
import { FaArrowLeft, FaUser, FaPhone, FaMapMarkerAlt, FaStickyNote, FaClock, FaGift } from "react-icons/fa"
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-2xl mx-auto px-4">
        {/* Header */}
        <div className="mb-8">
          <Link href="/products" className="inline-flex items-center text-pink-600 hover:text-pink-700 mb-4">
            <FaArrowLeft className="mr-2" />
            Quay lại
          </Link>
          <h1 className="text-3xl font-bold text-gray-900">Đặt hàng</h1>
          <p className="text-gray-600 mt-2">Vui lòng điền thông tin để đặt hàng</p>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-center mb-3">
                    ...
                    />
                    <label htmlFor="isGift" className="ml-2 text-sm font-medium text-gray-700 flex items-center">
                  ...
                  {customerInfo.isGift && (
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Lời nhắn tặng quà</label>
                      <textarea
